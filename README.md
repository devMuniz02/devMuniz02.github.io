...
| `config.local.json` | Top-level file included in the repository. |
| `data.json` | Top-level file included in the repository. |
| `index.html` | Top-level file included in the repository. |
...
1. Clone the repository.
   ...
   ```bash
   git clone https://github.com/devMuniz02/devMuniz02.github.io.git
   cd devMuniz02.github.io
   ```
